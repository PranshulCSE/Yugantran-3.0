  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? "bg-[#020617]/92 backdrop-blur-2xl border-b border-cyan-400/30 shadow-[0_10px_35px_rgba(0,242,254,0.12)] py-2.5"
          : "bg-[#020617]/60 backdrop-blur-xl border-b border-cyan-500/15 py-3.5"
      }`}
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <nav className="flex items-center justify-between h-12 sm:h-14">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="relative flex items-center gap-2">
              ...
              <div className="flex items-center">
                ...
                <span className="font-orbitron text-[10px] font-extrabold text-cyan-300 ml-1.5 px-2 py-0.5 rounded-full bg-cyan-950/90 border border-cyan-400/50 shadow-[0_0_12px_rgba(0,242,254,0.4)] tracking-widest">
                  3.0
                </span>
              </div>
            </div>
          ...
          {/* Desktop Nav Items */}
          <div className="hidden md:flex items-center gap-1.5 lg:gap-2 px-3 py-1.5 rounded-full bg-slate-900/60 border border-cyan-500/20 backdrop-blur-md shadow-inner">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `relative px-3.5 py-1.5 rounded-full font-mono-matrix text-xs lg:text-sm tracking-wider whitespace-nowrap transition-all duration-200 ${
                    isActive
                      ? "text-cyan-200 font-bold bg-cyan-950/80 border border-cyan-400/40 shadow-[0_0_15px_rgba(0,242,254,0.25)]"
          ...
          <div className="hidden md:flex items-center gap-3">
            {isRegistrationOpen ? (
              ...
              <div className="px-4 py-2 border border-rose-500/40 rounded-xl text-rose-400 font-orbitron text-xs tracking-wider bg-rose-950/30">
                REG. CLOSED
              </div>
            )}
          </div>
          ...
          <button
            ...
            className="md:hidden p-2.5 rounded-xl border border-cyan-500/40 bg-cyan-950/60 text-cyan-300 hover:text-white transition-colors shadow-[0_0_15px_rgba(0,242,254,0.2)]"
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="md:hidden bg-[#020617]/98 backdrop-blur-2xl border-t border-cyan-500/25 overflow-hidden shadow-2xl"
          >
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center justify-between px-4 py-3 rounded-xl font-mono-matrix text-sm tracking-widest transition-all ${
                      isActive
                        ? "bg-cyan-950/80 text-cyan-300 border border-cyan-400/50 shadow-[0_0_20px_rgba(0,242,254,0.25)] font-bold"
                        : "text-slate-300 hover:bg-slate-900/80 hover:text-cyan-300"
                    }`
                  }
                >
                  <span>&gt; {item.name.toUpperCase()}</span>
                  <span className="text-xs font-orbitron text-cyan-400/80 font-mono">0{NAV_ROUTES.indexOf(item) + 1}</span>
                </NavLink>
              ))}
