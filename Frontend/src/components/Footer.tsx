    ...
    <footer id="contact" className="relative border-t border-slate-200 dark:border-cyan-500/20 bg-white/90 dark:bg-[#020617]/90 backdrop-blur-2xl z-20 transition-colors duration-300">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 sm:gap-12 mb-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-lg bg-cyan-500/20 border border-cyan-400/40 flex items-center justify-center text-cyan-600 dark:text-cyan-300">
            ...
            <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed font-body">
              ...
              <strong className="text-cyan-700 dark:text-cyan-300 font-semibold">School of Computer Science & Engineering</strong> at{" "}
              <strong className="text-slate-900 dark:text-white font-semibold">Geeta University</strong>, Panipat-Delhi NCR.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3 font-space text-xs sm:text-sm text-slate-600 dark:text-slate-300">
              <div className="flex items-start gap-2.5">
                <MapPin className="w-4 h-4 text-cyan-500 dark:text-cyan-400 flex-shrink-0 mt-0.5" />
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a
                  ...
                  className="hover:text-cyan-600 dark:hover:text-cyan-300 transition-colors truncate font-semibold"
                >
            ...
            <div className="flex items-center gap-3 mt-6">
              <a
                ...
                title="Instagram"
                className="w-10 h-10 rounded-xl border border-slate-200 dark:border-cyan-500/30 bg-slate-100 dark:bg-cyan-950/40 flex items-center justify-center text-cyan-600 dark:text-cyan-400 hover:border-cyan-400 hover:text-white hover:bg-cyan-500 transition-all shadow-md"
              >
        ...
        <div className="border-t border-slate-200 dark:border-slate-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
          ...
          <Link
            to="/admin"
            className="font-mono-matrix text-xs text-slate-500 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors"
          >
            [ ADMIN PORTAL ]
          </Link>
        </div>
