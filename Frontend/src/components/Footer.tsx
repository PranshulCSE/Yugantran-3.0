      ...
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            ...
            <p className="text-[rgba(176,255,176,0.45)] text-sm leading-relaxed mb-4">
              Annual Technical Festival<br />
              School of Computer Science & Engineering<br />
              Geeta University, Panipat
            </p>
            <p className="font-mono-matrix text-xs text-[rgba(0,255,65,0.4)] tracking-widest">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["#home", "#about", "#timeline", "#events", "#register", "#team"].map((href) => (
                <li key={href}>
                  <button
        ...
        <div className="border-t border-[rgba(0,255,65,0.08)] pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="font-mono-matrix text-xs text-[rgba(176,255,176,0.25)] tracking-wider">
            © 2026 YUGANTRAN 3.0 // SCSE // GEETA UNIVERSITY, PANIPAT // ALL RIGHTS RESERVED
          </p>
          <a href="/admin" className="font-mono-matrix text-xs text-[rgba(0,255,65,0.2)] hover:text-[rgba(0,255,65,0.45)] transition-colors">
            admin
          </a>
        </div>
      </div>
