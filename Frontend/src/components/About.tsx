...
export default function About() {
  ...
  const domains = useMemo(() => [
    ...
    { icon: Trophy, label: "Competitive", color: "#ffd700" },
  ...
  return (
    <section id="about" ref={ref} className="relative py-24 overflow-visible">
      <div className="absolute top-1/4 -left-20 w-80 h-80 bg-[rgba(0,255,65,0.05)] rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-1/4 -right-20 w-80 h-80 bg-[rgba(0,255,65,0.03)] rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-[rgba(176,255,176,0.6)] text-lg max-w-3xl mx-auto leading-relaxed">
            YUGANTRAN 3.0 is the annual technical festival organized by the School of Computer Science & Engineering, Geeta University.
            This edition moves beyond conventional competitions — introducing real-world technology challenges in
            AI, Cybersecurity, Software Engineering, IoT and Innovation.
          </p>
        ...
        >
          {domains.map((d, i) => (
            ...
            >
              ...
              <p className="font-mono-matrix text-xs tracking-wider" style={{ color: d.color }}>{d.label}</p>
            </motion.div>
          ))}
        </motion.div>
        ...
        >
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              <p className="font-mono-matrix text-[#00ff41] text-xs tracking-widest mb-3">// PHILOSOPHY</p>
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <div className="text-[rgba(176,255,176,0.3)] line-through font-mono-matrix text-sm">2.0: Participate → Compete → Win</div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-[#00ff41]" />
                  <div className="text-[#b0ffb0] font-mono-matrix text-sm">3.0: Explore → Solve → Build → Innovate → Compete → Present</div>
                </div>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="text-center p-4 bg-[rgba(0,255,65,0.04)] rounded-lg border border-[rgba(0,255,65,0.1)]">
